...
"""
    ...
    def test_rag_system_query_without_api_key(self):
        ...
        try:
            ...
            expected_message = "I will tell you the answer once I am plugged in (have an API key)."
    ...
    def test_vector_store_error_conditions(self):
        ...
        try:
            ...
            try:
                vector_store = VectorStore(invalid_path, self.test_config.EMBEDDING_MODEL, 5)
                ...
                assert "error" in str(e).lower() or "permission" in str(e).lower() or "path" in str(e).lower()
    ...
    def test_full_integration_with_api_key(self):
        ...
        test_config_with_key.CHROMA_PATH = os.path.join(self.temp_dir, "test_chroma_with_key")
